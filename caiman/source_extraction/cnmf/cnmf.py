...
class CNMF(object):
    ...
    def __init__(self, n_processes,
                 ...
                 p=2,
                 dview=None,
                 Ain=None, Cin=None, b_in=None, f_in=None,
                 do_merge=True,
                 ssub=2, tsub=2, p_ssub=1, p_tsub=1,
                 method_init='greedy_roi',
                 alpha_snmf=None, rf=None, stride=None,
                 memory_fact=1,
                 gnb=1, nb_patch=1,
                 only_init_patch=False,
                 method_deconvolution='oasis',
                 n_pixels_per_process=4000, block_size_temp=5000, num_blocks_per_run_temp=20,
                 ...
                 fr=15, decay_time=0.4,                                   ## measurement data
                 min_SNR=2.5, ssub_B=2, init_iter=2,
        ...
        if self.params.get('patch', 'rf') is None:  # no patches
            ...
            self.estimates.A, self.estimates.C, self.estimates.YrA, self.estimates.b, self.estimates.f, \
                self.estimates.sn, self.estimates.optional_outputs = run_CNMF_patches(
                    ...
                    indeces=indeces, data_type=self.params.get('data', 'data_type'))
